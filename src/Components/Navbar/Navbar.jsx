                        ...
                        <div className="modal-box">
                            <form onSubmit={handleSubmit(onSubmitLogin)} method="dialog">
                                ...
                                <div className="mt-4">
                                    ...
                                    <input type="email" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" {...register("email", { required: true })} />
                                </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="flex items-center">
                                        <input name="password" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" type={showPassword ? 'password' : 'text'} {...register("password", { required: true })} />
                                        {showPassword ? (
